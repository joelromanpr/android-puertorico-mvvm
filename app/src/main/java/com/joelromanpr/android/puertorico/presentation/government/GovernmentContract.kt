...
interface GovernmentContract {
    ...
    data class GovernmentUiState(
        val isLoading: Boolean = false,
        val governmentData: GovernmentResponse? = null,
        val error: String? = null
    ) : UiState

    sealed class GovernmentUiAction : UiAction {
        object LoadGovernmentData : GovernmentUiAction()
    }
}
