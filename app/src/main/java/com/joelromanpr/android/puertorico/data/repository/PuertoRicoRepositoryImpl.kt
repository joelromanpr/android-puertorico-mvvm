...
import com.joelromanpr.android.puertorico.data.remote.PuertoRicoApiService
import javax.inject.Inject

class PuertoRicoRepositoryImpl @Inject constructor(
    private val apiService: PuertoRicoApiService
) : PuertoRicoRepository {

    override suspend fun getGovernmentData(): GovernmentResponse {
        return apiService.getGovernmentData()
    }
